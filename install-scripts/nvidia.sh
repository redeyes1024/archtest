...
# nvidia stuff
printf "${YELLOW} Checking for conflicting Hyprland packages (cleanup) if any..${RESET}\n"
if pacman -Qs hyprland > /dev/null; then
  printf "${YELLOW} Hyprland detected. Removing known conflicting Hyprland builds...${RESET}\n"
