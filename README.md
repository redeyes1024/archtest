...
# 💌 ** Arch i3wm Install Script ** 💌

> [!IMPORTANT]
> This repository has been migrated to **i3wm + Xorg**. Hyprland/Wayland references and assets may still exist for legacy reasons, but `install.sh` now installs i3wm and uses local dotfiles from `DotFIles/i3-Dots/`.
...
<div align="center">
👇 Legacy Hyprland-Dots links (not used by this installer) 👇
<br/>
</div>
<div align="center">
<br>
...
- This installer uses **local i3wm dotfiles** from `DotFIles/i3-Dots/` (installed when you select the `dots` option).
